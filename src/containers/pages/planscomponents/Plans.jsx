        ...
        <div>
          ...
          <h1 className="display-4">Choose Your Pricing Plan</h1>
            ...
            <div className="card-body">
              ...
              <button type="button" className="btn btn-lg btn-block border btn-outline">Purchase</button>
            </div>
          </div>
          <div className="card mb-4 shadow-sm">
            <div className="card-header">
          ...
          <div className="card mb-4 shadow-sm">
            ...
            <div className="card-body">
              <h1 className="card-title pricing-card-title">$12 <small className="text-muted">/ mo</small></h1>
              <ul className="list-unstyled mt-3 mb-4">
              ...
              <button type="button" className="btn btn-lg btn-block border btn-outline">Contact us</button>
            </div>
          </div>
        </div>
        </div>
